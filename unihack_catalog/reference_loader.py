...
TAXONOMY_KEYWORDS: Dict[str, tuple] = {
    ...
    "bandsaw": ("Hardware & Tools", "Power Tools", "Saws", "Hardware & Tools>Power Tools>Saws"),
    ...
    "drilling": ("Hardware & Tools", "Power Tool Accessories", "Drill Bits", "Hardware & Tools>Power Tool Accessories>Drill Bits"),
    ...
    "plusosb": ("Building Materials", "Plywood & Panels", "OSB Panels", "Building Materials>Plywood & Panels>OSB Panels"),
    "sub floor": ("Building Materials", "Plywood & Panels", "OSB Panels", "Building Materials>Plywood & Panels>OSB Panels"),
    ...
    "hardiepanel": ("Building Materials", "Siding", "Exterior Siding", "Building Materials>Siding>Exterior Siding"),
    ...
    "battery mounts": ("Hardware & Tools", "Power Tools", "Battery Mounts", "Hardware & Tools>Power Tools>Battery Mounts"),
    ...
    "raftersquare": ("Hardware & Tools", "Measuring Tools", "Layout Tools", "Hardware & Tools>Measuring Tools>Layout Tools"),
    ...
    "jumpstart": ("Hardware & Tools", "Power Tools", "Power Supplies", "Hardware & Tools>Power Tools>Power Supplies"),
    "jump starter": ("Hardware & Tools", "Power Tools", "Power Supplies", "Hardware & Tools>Power Tools>Power Supplies"),
    "pwr supply": ("Hardware & Tools", "Power Tools", "Power Supplies", "Hardware & Tools>Power Tools>Power Supplies"),
    "holster": ("Hardware & Tools", "Storage", "Tool Organizers", "Hardware & Tools>Storage>Tool Organizers"),
}
...
MOCK_UOMS = None
MOCK_DECIMALS = None
MOCK_GOLD_SET: List[Dict[str, Any]] = []
